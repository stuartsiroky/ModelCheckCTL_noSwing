...
import modelCheckCTL.util.ModelCheckCTLUtil;
import modelCheckCTL.view.JFrameView;
...
public class ModelCheckCTLController extends AbstractController {
	...
	/**
	 * This function takes the signals from the gui and calls the model to do
	 * the work. It will then inform the view what has happened.
	 * 
	 * @param option
	 *            This is the button on the gui that is pushed by the user.
	 */
	public void operationKS(String option) {
		...
		if (option.equals(ModelCheckCTLView.KRIPKE_STRUCT)) {
	...
	public void operationFormula(String option) {
		ModelCheckCTLView lview = ((ModelCheckCTLView) getView());
		ModelCheckCTLModel lmodel = ((ModelCheckCTLModel) getModel());
		System.out.println("ModelCheckCTLControler.operationFormula  "+option);
	...
	public void operationState(String option) {
		ModelCheckCTLView lview = ((ModelCheckCTLView) getView());
		ModelCheckCTLModel lmodel = ((ModelCheckCTLModel) getModel());
		System.out.println("ModelCheckCTLControler.operation  "+option);
		if (option.equals(ModelCheckCTLView.CHECK_STATE)) {
